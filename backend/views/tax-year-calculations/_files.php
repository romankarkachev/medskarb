...
<div class="tyc-files collapse" id="frmFiles" aria-expanded="false">
    <div class="card">
        ...
        <div class="card-block">
                ...
                'columns' => [
                    [
                        ...
                        'value' => function ($model, $key, $index, $column) {
                            /** @var $model \common\models\TaxYearCalculationsFiles */
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return Html::a('<i class="fa fa-cloud-download text-info" style="font-size: 18pt;"></i>', ['/tax-year-calculations/download', 'id' => $data->id], ['title' => ($data->ofn != ''?$data->ofn.', ':'').Yii::$app->formatter->asShortSize($data->size, false), 'target' => '_blank', 'data-pjax' => 0]);
                        },
                        'options' => ['width' => '60'],
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model) {
                                return Html::a('<i class="fa fa-trash-o"></i>', ['/tax-year-calculations/delete-file', 'id' => $model->id], ['title' => Yii::t('yii', 'Удалить'), 'class' => 'btn btn-sm btn-danger', 'aria-label' => Yii::t('yii', 'Delete'), 'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'), 'data-method' => 'post', 'data-pjax' => '0',]);
                            }
                        ],
                        'options' => ['width' => '40'],
                        'headerOptions' => ['class' => 'text-center'],
            ...
            <?= FileInput::widget([
                ...
                'pluginOptions' => [
                    'maxFileCount' => 10,
                    'uploadAsync' => false,
                    'uploadUrl' => Url::to(['/tax-year-calculations/upload-files']),
                    'uploadExtraData' => [
                        'owner_id' => $model->id,
                    ],
                    'fileActionSettings' => [
...
<?php
$urlPreview = Url::to(['/tax-year-calculations/preview-file']);
